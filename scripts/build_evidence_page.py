...
Turns docs/parameter_inventory.csv + outputs/sensitivity_ranking.csv into the
...
def main():
    ...
    rank = pd.read_csv(ROOT / "outputs/sensitivity_ranking.csv")
    scr = pd.read_csv(ROOT / "outputs/sensitivity_screening.csv")
...
<style>
:root{--surface:#FBFBF9;--panel:#fff;--panel2:#F4F4F0;--ink:#191C24;--ink2:#565B66;--ink3:#8B909C;
