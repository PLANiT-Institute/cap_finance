...
추첨 파라미터 10개(F2 랭킹 상위): `fac.ef_inc`, `vol.h2`, `tech.emission_factor`, `cfg.discount`, `vol.elec`, `tech.h2_intensity`, `price.h2`, `tech.elec_intensity`, `price.re`, `fac.capacity`.
...
|---|---|---|---|---|---|---|
| LOTTE Chemical | ±15% | 2,264 | 261 | 2,207 | -319 | **12%** |
| Mitsui Chemicals | ±15% | 875 | 101 | 851 | -125 | **12%** |
| Nippon Steel | ±15% | 32,187 | 7,044 | 32,862 | -6,370 | **21%** |
| POSCO | ±15% | 26,397 | 5,549 | 26,350 | -5,596 | **21%** |
| LOTTE Chemical | ±30% | 2,264 | 558 | 2,161 | -661 | **26%** |
| Mitsui Chemicals | ±30% | 875 | 214 | 833 | -256 | **26%** |
| Nippon Steel | ±30% | 32,187 | 14,540 | 35,075 | -11,652 | **41%** |
| POSCO | ±30% | 26,397 | 11,694 | 27,994 | -10,097 | **42%** |
...
| 기업 | ±15% | ±30% | 배율 |
|---|---|---|---|
| LOTTE Chemical | 261 | 558 | ×2.14 |
| Mitsui Chemicals | 101 | 214 | ×2.12 |
| Nippon Steel | 7,044 | 14,540 | ×2.06 |
| POSCO | 5,549 | 11,694 | ×2.11 |
...
|---|---|---|---|---|---|
| POSCO | 26,753 | 14,008 | 12,745 | 11,694 | **과정 선택** |
| Nippon Steel | 32,961 | 17,111 | 15,850 | 14,540 | **과정 선택** |
| Mitsui Chemicals | 864 | 512 | 352 | 214 | **과정 선택** |
| LOTTE Chemical | 2,242 | 1,333 | 909 | 558 | **과정 선택** |
