...
| A-14 | E2는 순서용 대리, 상대갭 2% | 설계서 §3 E4 | 소 (E4가 정본이므로) — **단 대리를 믿었다면 대** | `solve_status` 기록 + **M2에서 계량**: 대리비용·정본 P50의 순위상관이 철강 −0.05~0.00, 석화 0.20~0.73이고 대리 최저비용 계획이 정본 최저인 묶음은 **0/8**. `tests/test_paper_numbers.py` |
