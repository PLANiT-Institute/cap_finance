...
1. **NSC의 배출 원단위가 실적보다 15.7% 높다**(H2 후향 검증). 설비 목록이 고로 10기 단일 구성이라 전기로·스크랩 장입 몫이 빠졌다. 모형이 기존 설비를 실제보다 더 더럽다고 보므로 **전환 감축량을 과대, 감축 단가 ②를 과소평가**한다. POSCO는 ±2.7%로 통과. 석유화학 2사는 생산량 미공시라 **대조 자체가 불가**하다.
