...
POSCO, Nippon Steel, JFE Steel, Kobe Steel의 공식 기업 총량과 명시적 모델 추정치에 상관 가격경로 400개를 적용했다.

## 내부 1.5°C 스트레스에서 공시경로 고정 포트폴리오 재평가

| 기업 | 통합 실행가능성 | 미충족 제약 | 순현금 P50 | 탄소회피가치 | 경제적 Net P50 | TCaR | CAPEX | P90/EBITDA |
|---|---|---|---:|---:|---:|---:|---:|---:|
| POSCO | FAIL | 탄소예산(2030) | 48,424 | 15,183 | 116.5 | 32.6 | 22,752 | 10.06x |
| Nippon Steel | FAIL | 탄소예산(2035) | 40,297 | 17,046 | 69.7 | 18.8 | 23,974 | 3.00x |
| JFE Steel | FAIL | 자원·계통(2027) | 35,773 | 19,589 | 42.1 | 14.3 | 16,764 | 6.01x |
| Kobe Steel | FAIL | 탄소예산(2035)·자원·계통(2028) | 10,644 | 5,541 | 46.9 | 17.2 | 5,000 | 2.70x |
...
|---|---:|---:|---:|---|---:|---:|
| POSCO | 64 | 14 | 3 | CAND-6339E6B83A8408 | 53.2 | 15.7 |
| Nippon Steel | 64 | 23 | 1 | CAND-7400D0EA735D98 | 59.2 | 18.7 |
| JFE Steel | 64 | 3 | 1 | CAND-E8FAD9BDD034A5 | 26.3 | 25.5 |
| Kobe Steel | 25 | 6 | 1 | CAND-4D158AE8BC3521 | 91.5 | 24.6 |
...
결정론 기준으로 고정한 상위 후보 37개를 후보당·시나리오당 400경로로 다시 평가하고 전력·수소입력·건설 CAPEX의 정확한 3요인 Shapley 분산배분을 재계산했다.

| 기업 | 정밀 후보 | λ=1 후보 | 최대후회 P50 | 최악 TCaR | 최악경로 전력 | 수소입력 | 건설비 |
|---|---:|---|---:|---:|---:|---:|---:|
| POSCO | 10 | CAND-6339E6B83A8408 | 53.6 | 15.0 | 89.5% | 4.0% | 6.5% |
| Nippon Steel | 10 | CAND-7400D0EA735D98 | 59.0 | 18.6 | 94.0% | 2.4% | 3.6% |
| JFE Steel | 7 | CAND-E8FAD9BDD034A5 | 26.7 | 26.3 | 94.9% | 3.0% | 2.1% |
| Kobe Steel | 10 | CAND-4D158AE8BC3521 | 93.1 | 26.3 | 93.5% | 4.0% | 2.5% |
...
정밀 후보집합은 seed가 아니라 중앙가격 screening으로 고정해 반복 간 후보 변경을 막았다. 최대후회 기준점은 이 shortlist 안의 시나리오별 최저 적격안이며, 전체 910개 후보를 모두 400경로로 평가한 결과는 아니다.
